        ...
        Box(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { text ->
                        text.toIntOrNull()?.let { viewModel.onAction(BattleGridActions.OnStartingLifeChanged(it)) }
                    },
                ...
                Row(
                    ...
                    Switch(
                        ...
                        onCheckedChange = {
                            viewModel.onAction(BattleGridActions.OnAllowSelfCommanderDamageChanged(it))
                        }
                    )
                }
                ...
                Row(
                    ...
                    Switch(
                        ...
                        onCheckedChange = {
                            viewModel.onAction(BattleGridActions.OnLinkCommanderDamageToLifeChanged(it))
                        }
                    )
                }
            }
